...
namespace MvcCrud.Controllers
{
    public class EnderecoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Rua,Numero,Bairro,Cep")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Rua,Numero,Bairro,Cep")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
